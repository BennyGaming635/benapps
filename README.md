...
Simple GitHub Pages-ready portfolio website for showcasing your apps.

## Files

- `index.html` - Home page with placeholders for bio, app cards, App Store links, and app photos
